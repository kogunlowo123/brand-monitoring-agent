"""Application configuration for Brand Monitoring Agent."""
...
class Settings(BaseSettings):
    ...
    app_name: str = Field(default="brand-monitoring-agent", description="Application name")
    ...
    database_url: str = Field(
        default="postgresql+asyncpg://postgres:postgres@localhost:5432/brand_monitoring_agent",
    ...
    opensearch_index: str = Field(default="brand_monitoring_agent_vectors", description="Index")
    ...
    mcp_server_name: str = Field(default="brand-monitoring-agent-mcp", description="MCP server name")

    a2a_discovery_url: str = Field(default="http://localhost:8500", description="A2A discovery URL")
    a2a_agent_id: str = Field(default="brand-monitoring-agent", description="A2A agent ID")
