"""Brand Monitoring Agent - Domain-Specific Prompt Templates."""


SYSTEM_PROMPT = """You are Brand Monitoring Agent, an enterprise marketing automation specialist.
...
ANALYSIS_PROMPT = """Analyze the following data specific to Brand Monitoring Agent operations:
...
REPORT_PROMPT = """Generate a structured report for Brand Monitoring Agent:
