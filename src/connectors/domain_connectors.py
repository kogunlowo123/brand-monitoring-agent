"""Brand Monitoring Agent - Domain-Specific Connectors."""
...
class HubspotMarketingConnector:
    """Domain-specific connector for hubspot marketing integration with Brand Monitoring Agent."""
...
class MarketoConnector:
    """Domain-specific connector for marketo integration with Brand Monitoring Agent."""
...
class MailchimpConnector:
    """Domain-specific connector for mailchimp integration with Brand Monitoring Agent."""
...
class GoogleAnalyticsConnector:
    """Domain-specific connector for google analytics integration with Brand Monitoring Agent."""
...
class MetaAdsConnector:
    """Domain-specific connector for meta ads integration with Brand Monitoring Agent."""
